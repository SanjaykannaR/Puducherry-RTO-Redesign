...
// ── Dashboard home ──
// Shows a welcome header with summary stats and quick-link cards.
...
import { Car, FileText, Calendar, Search, ClipboardList, ArrowRight, LogOut, AlertTriangle, User } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const [summary, setSummary] = useState<Summary>({ pendingChallans: 0, upcomingAppointments: 0, activeApplications: 0 });
  ...
  useEffect(() => {
    ...
    async function loadSummary() {
      try {
        const [challansRes, appsRes] = await Promise.allSettled([
          ...
          <div className="relative mx-auto px-4 sm:px-6 py-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-white/15 flex items-center justify-center border-2 border-white/25 shrink-0">
